...
overall_mat_avg_aal, overall_mat_min_aal, overall_mat_max_aal, overall_mat_std_aal, overall_mat_sum_aal = [], [], [], [], []
overall_mat_avg_h, overall_mat_min_h, overall_mat_max_h, overall_mat_std_h, overall_mat_sum_h = [], [], [], [], []
overall_mat_avg_kmeans, overall_mat_min_kmeans, overall_mat_max_kmeans, overall_mat_std_kmeans, overall_mat_sum_kmeans = [], [], [], [], []
overall_mat_avg_sch, overall_mat_min_sch, overall_mat_max_sch, overall_mat_std_sch, overall_mat_sum_sch = [], [], [], [], []
overall_mat_avg_ward, overall_mat_min_ward, overall_mat_max_ward, overall_mat_std_ward, overall_mat_sum_ward = [], [], [], [], []
...
for subject in glob.glob(ip_path,recursive=True): #Input path   
    ...
    mat_avg_aal, mat_min_aal, mat_max_aal, mat_std_aal, mat_sum_aal = statistics_matrix(matrix_aal)
    ...
    mat_avg_h, mat_min_h, mat_max_h, mat_std_h, mat_sum_h = statistics_matrix(matrix_harvard)
    ...
    mat_avg_kmeans, mat_min_kmeans, mat_max_kmeans, mat_std_kmeans, mat_sum_kmeans = statistics_matrix(matrix_kmeans)
    ...
    mat_avg_sch, mat_min_sch, mat_max_sch, mat_std_sch, mat_sum_sch = statistics_matrix(matrix_schaefer)
    ...
    mat_avg_ward, mat_min_ward, mat_max_ward, mat_std_ward, mat_sum_ward = statistics_matrix(matrix_ward)
...
df = pd.DataFrame({'Method': ['AAL', 'Harvard', 'Schaefer','Kmeans', 'Ward'],
                   'Average': [np.std(overall_mat_avg_aal), np.std(overall_mat_avg_h), np.std(overall_mat_avg_sch), np.std(overall_mat_avg_kmeans), np.std(overall_mat_avg_ward)],
                   'Minimum': [np.std(overall_mat_min_aal), np.std(overall_mat_min_h), np.std(overall_mat_min_sch), np.std(overall_mat_min_kmeans), np.std(overall_mat_min_ward)],
                   'Maximum': [np.std(overall_mat_max_aal), np.std(overall_mat_max_h), np.std(overall_mat_max_sch), np.std(overall_mat_max_kmeans), np.std(overall_mat_max_ward)],
                   'SD': [np.std(overall_mat_std_aal), np.std(overall_mat_std_h), np.std(overall_mat_std_sch), np.std(overall_mat_std_kmeans), np.std(overall_mat_std_ward)],
                   'Sum': [np.std(overall_mat_sum_aal), np.std(overall_mat_sum_h), np.std(overall_mat_sum_sch), np.std(overall_mat_sum_kmeans), np.std(overall_mat_sum_ward)]})
